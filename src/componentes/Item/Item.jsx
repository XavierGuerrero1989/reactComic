  ...
  return (
    <div className="col-md-3 d-flex justify-content-center stockCard">
      <Card style={{ width: "18rem" }}>
        ...
        <Card.Body>
          <Card.Text>{JSON.stringify(comic.titulo)}</Card.Text>
          <Link
            to={ruta}
            element={<ItemDetailContainer idDelComic={idHeredado} />}
          >
            <Button variant="success">Ver detalles del Producto</Button>
          </Link>
        </Card.Body>
      </Card>
    </div>
